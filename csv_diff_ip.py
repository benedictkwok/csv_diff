...
def sophos_devices():
    ...
    device = '/Users/bkwok/Downloads/sophos_devices_06.csv'  # date: 06-22-2020
...
def sophos_servers():
    ...
    server = '/Users/bkwok/Downloads/sophos_servers_06.csv'  # date: 06-22-2020
...
def iventi_devices():
    ...
    iventi = '/Users/bkwok/Downloads/Iventi_all_devices_0622.csv'  # date: 06-22-2020
...
def add_sophos_column_to_Iventi(sophos_device_hosts):
    ...
    iventi = pd.read_csv('/Users/bkwok/Downloads/Iventi_all_devices_0622.csv' )
    ...
    #print (iventi.head())
    iventi.to_csv('/Users/bkwok/Downloads/Iventi_Sophos-0622.csv', index=False)
    print ("Writing file to .../Users/bkwok/Downloads/Iventi_Sophos-0622.csv")
"""def nessus():
